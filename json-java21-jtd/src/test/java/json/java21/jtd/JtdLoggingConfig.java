...
public class JtdLoggingConfig {
    ...
    static void enableJulDebug() {
        ...
        if (prop == null || prop.isBlank()) {
            ...
            System.setProperty("jtd.test.resources", base.toString());
            Logger.getLogger(JtdLoggingConfig.class.getName()).config(
                () -> "jtd.test.resources set to " + base);
        }
    }
}