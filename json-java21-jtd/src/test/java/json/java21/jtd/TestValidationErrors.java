...
public class TestValidationErrors extends JtdTestBase {
  ...
  @Test
  public void testTypeSchemaErrorMessages() throws Exception {
    ...
    assertThat(booleanResult.errors().get(0)).contains("expected boolean, got JsonNumber");
    ...
    assertThat(stringResult.errors().get(0)).contains("expected string, got JsonNumber");
    ...
    assertThat(intResult.errors().get(0)).contains("expected int32, got JsonString");
    ...
    assertThat(floatResult.errors().get(0)).contains("expected float32, got JsonString");
    ...
    assertThat(timestampResult.errors().get(0)).contains("expected timestamp (string), got JsonNumber");
  ...
  @Test
  public void testVerboseErrorMode() throws Exception {
    ...
    String conciseError = conciseResult.errors().get(0);
    ...
    String verboseError = verboseResult.errors().get(0);
  ...
  @Test
  public void testEnumSchemaErrorMessages() throws Exception {
    ...
    assertThat(invalidValueResult.errors().get(0)).contains("value 'yellow' not in enum: [red, green, blue]");
    ...
    assertThat(nonStringResult.errors().get(0)).contains("expected string for enum, got JsonNumber");
  ...
  @Test
  public void testArraySchemaErrorMessages() throws Exception {
    ...
    assertThat(nonArrayResult.errors().get(0)).contains("expected array, got JsonString");
    ...
    assertThat(invalidElementResult.errors().get(0)).contains("expected string, got JsonNumber");
  ...
  @Test
  public void testObjectSchemaErrorMessages() throws Exception {
    ...
    assertThat(nonObjectResult.errors().get(0)).contains("expected object, got JsonString");
    ...
    assertThat(missingPropertyResult.errors().get(0)).contains("missing required property: age");
    ...
    assertThat(invalidPropertyResult.errors().get(0)).contains("expected string, got JsonNumber");
  ...
  @Test
  public void testAdditionalPropertiesErrorMessages() throws Exception {
    ...
    assertThat(additionalPropResult.errors().get(0)).contains("additional property not allowed: extra");
  ...
  @Test
  public void testDiscriminatorSchemaErrorMessages() throws Exception {
    ...
    assertThat(invalidDiscriminatorResult.errors().get(0)).contains("discriminator 'type' must be a string");
    ...
    assertThat(unknownDiscriminatorResult.errors().get(0)).contains("discriminator value 'unknown' not in mapping");
  ...
  @Test
  public void testUnknownTypeErrorMessage() throws Exception {
    ...
    assertThat(result.errors().get(0)).contains("unknown type: unknown-type");
  ...
  @Test
  public void testErrorMessageConsistency() throws Exception {
    JsonValue invalidData = Json.parse("123");
